      ...
      <div className="flex flex-wrap items-center gap-3 border-b border-slate-800/80 pb-4">
        <button
          ...
          className={`px-4 py-2.5 rounded-xl text-xs sm:text-sm font-bold transition flex items-center gap-2 ${
            activeTab === "batch"
              ? "bg-teal-600 text-white shadow-lg shadow-teal-500/25 ring-1 ring-teal-400/50"
              : "bg-slate-900/80 text-slate-400 hover:text-slate-200 border border-slate-800"
          }`}
        >
          <Layers className="h-4 w-4" />
          <span>Audit Batch Faskes (50 Klaim)</span>
          <span
            className={`text-[10px] px-1.5 py-0.2 rounded font-mono ${
              activeTab === "batch" ? "bg-teal-700/80 text-teal-100" : "bg-slate-800 text-slate-400"
            }`}
          >
            Batch
          </span>
        ...
        >
          ...
          <span>Verifikasi Kasus Tunggal</span>
        </button>
      </div>

      {/* Conditional View: Batch vs Single */}
      {activeTab === "batch" ? (
        <BatchAuditView />
      ) : (
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="flex items-center justify-between text-xs text-slate-400">
                        <span>
                          ICD: <strong className="text-slate-200">{c.primaryIcd}</strong>
                        </span>
                ...
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-5 border-b border-slate-800">
                  <div className="space-y-1">
                    ...
                    <h3 className="text-lg font-bold text-white">
                      {selectedCase.patientName} ({selectedCase.age} th)
                    </h3>
